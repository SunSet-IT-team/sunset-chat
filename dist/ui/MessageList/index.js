...
const MessageList = ({ chat, socket }) => {
    ...
    const { data, isLoading, ref, setCanLoad, isFirstPageLoaded } = useChatMessages(chat.id);
    const messages = data || [];
    const { messageListRef } = useScrollObserver(messages, isFirstPageLoaded, setCanLoad);
